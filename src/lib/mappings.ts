...
export const SYSTEM_MAPPINGS: { category: string; keywords: string[] }[] = [
  ...
  },
  {
    ...
    keywords: ['Receptacle', 'Outlet', 'Plug', 'Motor', 'Device Box', 'Plaster Ring', 'Cover Plate', 'Plate', 'Decora']
  },
  {
...
export const WORD_BOUNDARY_KEYWORDS = ['fa', '105', 'led', 'ot', 'lug', 'rod', 'bond', 'bus', 'jb', 'plate'];
